...
import com.tenkent.point.mall.common.dto.MallResult;
...
public class PointTestController {
    ...
    public MallResult<PointTestL> test( @ApiParam(required = true, name = "who", value = "who") @PathVariable("who") String who)
    {
        System.out.print(who);
        List<PointTestL> aa = iPointTestService.getAll();
        return new MallResult<PointTestL>(true, aa.get(0));
    }
}
