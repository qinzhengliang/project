...
@Api(value = "/seckill", description="seckill Api")
public class SeckillController
{
    ...
    @RequestMapping(value = "/time/now/{zone}", method = RequestMethod.GET)
    @ResponseBody
    @ApiOperation(value = "获取系统时间", httpMethod = "GET", response = SeckillResult.class)
    public SeckillResult<Long> time(
        @ApiParam(required = true, name = "zone", value = "地区") @PathVariable("zone") String zone)
    {
